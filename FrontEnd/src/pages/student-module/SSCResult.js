    ...
    render () {
        return (
            ...
            <div className="flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                ...
                <h4 style={{textAlign: "center"}}>Detailed Result of Secondary School Certificate (SSC) Examination</h4>
                <div class="col d-flex justify-content-center">
                <Card style={{ alignContent: "center", display: "flex", position: "center", backgroundColor: "#f5f8fc", border: "0", marginTop:"-5px" }}>
                    <Card.Header style={{textAlign:"center"}}>
                    <h5><b>{this.props.applicant.name}</b></h5>
                    </Card.Header>
                    <Card.Body style={{marginLeft: "0", fontSize:"small"}}>
                        <Row>
                            <Col>
                                <h7 style={{display: "inline", fontSize:"15px", fontWeight:"bold"}}>Roll No.:</h7> {this.props.applicant.sscinfo.roll}
                            </Col>
                            <Col>
                                <h7 style={{display: "inline", fontSize:"15px", fontWeight:"bold"}}>Board:</h7> {this.props.applicant.sscinfo.board}
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                                <h7 style={{display: "inline", fontSize:"15px", fontWeight:"bold"}}>Group:</h7> {this.props.applicant.sscinfo.group}
                            </Col>
                            <Col>
                                <h7 style={{display: "inline", fontSize:"15px", fontWeight:"bold"}}>Passing Year:</h7> {this.props.applicant.sscinfo.passingyear}
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
            ...
            <Card.Body className="pb-0">
              <Table responsive className="table-centered table-nowrap rounded mb-0 ssc-result-table">
                {
                ...
                <thead className="thead-light">
                  <tr>
                    <th className="border-0">Subject<br/>Code</th>
                    <th className="border-0">Subject<br/>Name</th>
                    <th className="border-0">Obtained<br/>Marks</th>
                    <th className="border-0">Letter<br/>Grade</th>
                    <th className="border-0">Grade<br/>Point</th>
                  </tr>
                </thead>
                }
                <tbody>
                    <tr>
                        ...
                        <td rowSpan = "2" style={{verticalAlign:"middle"}}>{this.props.applicant.sscresult[0].gradepoint}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td rowSpan = "2" style={{verticalAlign:"middle"}}>{this.props.applicant.sscresult[2].gradepoint}</td>
                    </tr>
                    <tr>
                    ...
                    {
                        this.props.applicant.sscresult.slice(4).map 
                        (
                            student => 
                                <tr>
                    ...
                    <tr>
                        <td style={{textAlign:"left", fontWeight:"bold", borderBottom: "0"}}></td>
                        {!this.state.singleColumn && <td style={{textAlign:"left", fontWeight:"bold", borderBottom: "0"}}></td>}
                        <td colSpan={(!this.state.singleColumn && "2") || (this.state.singleColumn && "3")} style={{textAlign:"center", fontWeight:"bold"}}>
