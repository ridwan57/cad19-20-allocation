        ...
        fetch(studentModuleRootAddress+'/getPaymentHistory', {
            ...
            .then(data => {
                data.result.forEach((element, id) => {
                    ...
                    element.timeStamp = moment(element.timeStamp).subtract(6, 'hours').format('YYYY-MM-DD, h:mm:ss A').toString();
                });
