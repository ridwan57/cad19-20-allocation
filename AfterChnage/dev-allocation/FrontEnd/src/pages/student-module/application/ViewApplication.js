...
import { Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Button, IconButton, Tooltip } from '@material-ui/core';
...
class ViewApplication extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            applicationSubmittedPrompt: (this.props.match.params.status === 'success' && true) || false,
            applicationSubmitted: (this.props.match.params.status === 'success' && true) || false,
            loading: true,
    ...
    componentDidMount() {
        ...
        if (this.props.applicant.PaymentSuccess != null) {
            ...
            this.setState({ applicationSubmitted: true, applicationSubmittedPrompt: true });
        }
        ...
        fetch(studentModuleRootAddress + '/getApplicationChoices', {
            ...
            .then(data => {
                ...
                lst.forEach(element => {
                    ...
                    element.isSQGranted = (element.isSQ === false && "N/A") ||
                ...
                if (selectedEIINListUnique.length >= 5) this.setState({ eligibilityOfSubmission: 'Yes' });
    ...
    submitConfirmButtonPressed() {
        this.setState({ showPaymentRedirectionMsg: true, showSubmitConfirmationMsg: false });
    ...
    render() {
        ...
        if (this.state.gatewayRedirect) return (<Route render={() => (window.location = this.state.gatewayPageURL)} />);
        const options = {
            filter: true,
            filterType: "dropdown",
        ...
        return (
            (this.state.redirectToUpdateApplication && <Redirect to={Routes.studentUser.Application.SubmitApplication.path} />) ||
            <>
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText className="dialoge-text">
                            Do your really want to submit your currectly saved choices? Once submitted, you can not modify your application.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions className="dialoge-text">
                        <Button onClick={this.submitCancelButtonPressed} color="secondary" autoFocus>
                            Cancel
                        </Button>
                        <Button onClick={this.submitConfirmButtonPressed} color="primary" autoFocus>
                            OK
                        </Button>
                    </DialogActions>
                </Dialog>
                ...
                >
                    ...
                    <DialogActions className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={this.submitApplicationSuccessMessageAcceptedButtonPressed} color="primary" autoFocus variant='contained'>
                            OK
                        </Button>
                    </DialogActions>
                </Dialog>
                ...
                <div className="flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                    <div className="d-block mb-4 mb-xl-0">
                        ...
                        <div class="col d-flex justify-content-center choice-table-view" style={{ paddingTop: "20px" }}>

                            <Card style={{ width: "1600px", alignContent: "center", display: "flex", position: "center", backgroundColor: "#f5f8fc", border: "0" }}>
                                {
                                    //this.props.applicant.applicationStatus < 2 &&
                                    this.props.applicant.applicationStatus <= CADApplicationStatuses.Submitted &&
                                    <Card.Body>
                                        <div class="row veiw-application">
                                            <div class="col-sm-6 col-md-6 col-33-pct">
                                                <h7>Min EIIN Required: {this.state.minimumEIINCount}</h7>
                                            </div>

                                            <div class="col-sm-6 col-md-6 col-33-pct">
                                                <h7>Max EIIN Allowed: {this.state.maximumEIINCount}</h7>
                                            </div>
                        ...
                        <div class="col d-flex justify-content-center" style={{ paddingTop: "20px" }}>
                            ...
                            <Card style={{ width: "98%", alignContent: "center", position: "center", border: "1" }}>
                                <Card.Header>
                                    <div className='row'>
                                        <div className='col-6'>
                                            <h6 style={{ display: "inline" }}>Submitted Choice List of </h6>
                                            <h5 style={{ display: "inline" }}><b>{this.props.keycloak.tokenParsed.name}</b></h5>
                                        </div>
                                ...
                                <Card.Body>
                                    ...
                                    }
                                    {
                                        ...
                                        <div style={{ textAlign: "center" }}>
                                            <h5>
                                                You Have Not Saved/Submitted Your Choices. Click <a href={Routes.studentUser.Application.SubmitApplication.path}>Here</a> or Navigate To "Make Application" to Apply.
                                            </h5>
                                        </div>
                                    }
                                </Card.Body>
