...
class SubmitApplication extends Component {
    ...
    componentDidMount() {
        ...
        fetch(studentModuleRootAddress + '/getApplicationChoices', {
            ...
            if (data.result.length > 0) {
                ...
                this.id = setTimeout(() => this.setState({ alreadySubmittedPrompt: false }), 3000);
            }
        });
    ...
    isSVGAllowed(svg) {
        ...
        {
            { console.log("Ret 0"); return false; }
        }
        ...
        { console.log("Ret 1"); return false; }
        ...
        { console.log("Ret 2"); return false; }
        if ((this.state.gender.charAt(0) === 'M' && svg.gender.charAt(0) === 'F') || (this.state.gender.charAt(0) === 'F' && svg.gender.charAt(0) === 'M')) { console.log("Ret 3"); return false; }
        return isAllowed;
    }
    ...
    submitApplication() {
        ...
        for (var property in gwprocessParameters) {
            ...
            var encodedValue = '';
            if (property === 'tran_id') encodedValue = encodeURIComponent(this.props.keycloak.tokenParsed.CRVSID);
        ...
        return (
            ...
            <>
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText className="dialoge-text">
                            You already have a submitted your application choices. You can update it at your preference.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={() => this.setState({ alreadySubmittedPrompt: false })} color="primary" variant='contained' autoFocus>
                            OK
                        </Button>
                    </DialogActions>
                </Dialog>
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText className="dialoge-text">
                            Do your really want to submit your currectly selected choices? The submission will be followed by the payment process. You can modify your application after the sucessful submission.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={() => this.setState({ submitApplicationPrompt: false })} color="secondary" variant='contained' autoFocus>
                            Cancel
                        </Button>
                        <Button onClick={() => {
                ...
                >
                    ...
                    <DialogActions className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={() => this.setState({ updateApplicationPrompt: false })} color="secondary" variant='contained' autoFocus>
                            Cancel
                        </Button>
                        <Button onClick={() => {
                ...
                >
                    <DialogTitle className="dialoge-text">{"Attention!"}</DialogTitle>
                    <DialogContent>
                        <DialogContentText className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                ...
                >
                    ...
                    <DialogActions className="dialoge-text" className="dialoge-text" style={{ justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={() => {
                            ...
                            <div style={{ width: "100%" }}>
                                <div className="row">
                                    <div className="col-xl-12 col-40-pct">
                                            ...
                                            <Accordion.Item eventKey="1">
                                                ...
                                                <Accordion.Body>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-12" style={{ paddingTop: "20px", textAlign: "right" }}>
                                                            <Button
                                        ...
                                        <div className="col d-flex justify-content-center higher-padded-card" style={{ paddingTop: "20px" }}>
                                        ...
                                        <div style={{ width: "100%" }}>
                                            ...
                                            <div className="col d-flex justify-content-center lower-padded-card">
                                                <Card style={{ width: "100%", alignContent: "center", position: "center", border: "1" }}>
                                                    <Card.Header>
                                                        <h6 style={{ display: "inline" }}>Choice List of </h6><h5 style={{ paddingLeft: '4px', display: "inline" }}>{this.props.keycloak.tokenParsed.name}</h5>
                                                    </Card.Header>
                                                    <Card.Body>
                                            ...
                                            <div className="row">
                                                <div className="col-12" style={{ paddingTop: "20px", textAlign: "center" }}>
                                                    <Button
                                                        onClick={() => {
                                                            if (this.state.showSubmitButton) this.setState({ submitApplicationPrompt: true });
                                                            if (this.state.showUpdateButton) this.setState({ updateApplicationPrompt: true });
                                                        }}
                                                        variant="contained"
                                                        color="primary"
                                                        size="medium"
                                                        ...
                                                        startIcon={<SaveIcon />}
                                                    >
                                                        {this.state.showSubmitButton && "Submit Application"}
