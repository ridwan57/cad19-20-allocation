...
import Settings from './board-module/Settings'

import ImportResultData from './board-module/ImportResultData'

import Unauthorized from './Unauthorized'
import { CADApplicationStatuses } from './institution-module/ApplicationStatuses'
import ErrorComponent from 'react-500'
		...
		if (this.state.keycloak) {
			if (this.state.authenticated) {
              ...
              /> */}
							...
							<RouteWithSidebar
								exact
								path={Routes.board.Configuration.Settings.path}
								component={Settings}
								//applicant={this.state.applicant}
								//institute={this.state.institute}
								//updateFunctions={{
							...
							<RouteWithSidebar
								exact
								path={Routes.board.ImportResultData.path}
								component={ImportResultData}
								//applicant={this.state.applicant}
								//institute={this.state.institute}
								//updateFunctions={{
								//  applicationStatusUpdater: this.updateApplicationStatus,
