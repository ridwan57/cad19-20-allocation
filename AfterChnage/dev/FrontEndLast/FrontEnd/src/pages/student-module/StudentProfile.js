...
class StudentProfile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      applicant: {
        ...
        address: {
          present:
            "B-13, E-04, AGB Colony (Al-Helal Zone), Motijheel, Dhaka - 1000",
          permanent:
            "Village: Chowbari, Post Office: Chowbari, Police Station: Kamarkhan, DIstrict: Sirajganj",
        },
      },
      sscInfo: {
        // eduInstitution: {
  ...
  componentDidMount() {
    ...
    fetch(studentModuleRootAddress + "/getCRVSProfile", {
      ...
      .then((data) => {
        if (data.status === 500) Promise.reject();
          ...
          data.result.forEach((element, id) => {
            ...
            element.timeStamp =
              ...
              moment(element.timeStamp)
                ...
                .toString(); //Date.parse(element.timeStamp).toDateString();
          });
                              ...
                              <Card.Body>
                                <div class="personal-ssc-info">
                                  <Row>
                                    ...
                                    <Col>{this.state.applicant.crvsId}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                                  ...
                                  <Row>
                                    ...
                                    <Col>{this.state.applicant.fatherName}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                                      <h6>Mother's Name</h6>
                                    </Col>
                                    <Col>{this.state.applicant.motherName}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                                      <h6>Date of Birth</h6>
                                    </Col>
                                    <Col>{this.state.applicant.dob}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                                      <h6>Gender</h6>
                                    </Col>
                                    <Col>{this.state.applicant.gender}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                                      <h6>Contact No</h6>
                                    </Col>
                                    <Col>{this.state.applicant.contactNo}</Col>
                                  </Row>
                                  <Row>
                                    <Col>
                      ...
                      <div style={{ paddingTop: "10px" }}>
                        <div class="row">
                          <div
                            class={
                              "col-md-12 col-lg-6" +
                              (!this.state.singleColumn && " padded-down")
                            }
                          >
                            {this.state.sscInfo && (
                              <div class="personal-ssc-info">
                                <Card style={{ minHeight: "350px" }}>
                                  ...
                                  <Card.Body>
                                    ...
                                    <Row>
                                      ...
                                      <Col>{this.state.sscInfo.sscYear}</Col>
                                    </Row>
                                    <Row>
                                      <Col>
                                        <h6>GPA (with 4th Subject)</h6>
                                      </Col>
                                      <Col>{this.state.sscInfo.sscGPA}</Col>
                                    </Row>
                                    <Row>
                                      <Col>
                                    ...
                                    {this.state.ranking.preSRank && (
                                      <Row>
                                        ...
                                        <Col>
                                          {this.state.ranking.sMeritStart} -{" "}
                                          {this.state.ranking.sMeritEnd}
                                        </Col>
                                      </Row>
                                    )}
                                    {this.state.ranking.preARank && (
                                      <Row>
                                        ...
                                        <Col>
                                          {this.state.ranking.aMeritStart} -{" "}
                                          {this.state.ranking.aMeritEnd}
                                        </Col>
                                      </Row>
                                    )}
                                  </Card.Body>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Row>
                                        ...
                                        <Col>
                                          ...
                                          {(this.props.applicant
                                            .applicationStatus !==
                                            CADApplicationStatuses.NotApplied &&
                                            Number(
                                              this.props.applicant.noOfUpdates
                                            ) - 1) ||
                                            "N/A"}
                                        </Col>
                                      </Row>
                                  ...
                                  <Card>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Row>
                                        <Col>
                                          <h6>
                                            Allocation Confirmation Payment
                                          </h6>
                                        </Col>
                                        <Col>N/A</Col>
                                      </Row>
                                  ...
                                  <Card>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Row>
                                        <Col>
                                          <h6>
                                            Allocation Confirmation Deadline
                                          </h6>
                                        </Col>
                                        <Col>N/A</Col>
                                      </Row>
